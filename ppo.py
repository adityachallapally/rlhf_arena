...
This module implements the PPO algorithm for reinforcement learning from human feedback.
"""
...
class PPOTrainer:
    ...
    def train_step(self, batch: Dict[str, torch.Tensor]) -> Dict[str, float]:
        ...
        entropy_loss = -ppo_config['entropy_coef'] * entropy
        
        # KL penalty
        kl_loss = ppo_config['kl_coef'] * kl_div
    ...
    def train(self, train_dataloader: DataLoader, eval_dataloader: Optional[DataLoader] = None):
        ...
        self.logger.info(f"Starting training for {training_config['max_epochs']} epochs")
